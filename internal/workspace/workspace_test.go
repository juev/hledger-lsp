...
2024-02-01 Root
    ...
    expenses:food  $5
    assets:bank`
	ws.MarkFileDirty(childPath, StaticContent(updatedContent))
...
func TestWorkspace_IndexSnapshot_IncludeChange(t *testing.T) {
	...
	ws.MarkFileDirty(mainPath, StaticContent("include one.journal\ninclude two.journal"))
	snapshot = ws.IndexSnapshot()
	assert.Contains(t, snapshot.Accounts.All, "expenses:travel")

	ws.MarkFileDirty(mainPath, StaticContent("include two.journal"))
	snapshot = ws.IndexSnapshot()
...
`
    ...
    assets:cash
`
	ws.MarkFileDirty(mainPath, StaticContent(updatedContent))
...
func TestWorkspace_AddMissingReachable_CRLF(t *testing.T) {
	...
	ws.MarkFileDirty(mainPath, StaticContent("include child.journal\n\n2024-01-01 Main\n    expenses:food  $10\n    assets:cash\n"))
...
`
	...
	ws.MarkFileDirty(rulesPath, StaticContent(rulesContent))
...
func TestWorkspace_UpdateFile_OccurrencesPreserved(t *testing.T) {
	...
	ws.MarkFileDirty(rootPath, StaticContent("include child.journal\n\n2024-01-02 root tx edited\n    expenses:food  $25\n    assets:cash\n"))
...
func TestWorkspace_UpdateFile_ReloadsAllOwners(t *testing.T) {
	...
	ws.MarkFileDirty(childPath, StaticContent("2024-01-01 child tx edited\n    expenses:child  $99\n    assets:cash\n"))
