...
**7) Diagnostics: дубликаты транзакций** *(отменено)*
...
- [x] Конфигурируемые лимиты: file size, include depth, max results
- [x] Бенчмарки для новых completion и index‑операций
- [x] Профилирование горячих путей и оптимизация

### 9) Тесты и тестовые данные

- [x] Unit‑тесты для tag/date/template completion
- [x] Интеграционные тесты definition/references
- [x] Добавить testdata для новых сценариев

### 10) Документация

- [x] Обновить `README.md` (таблица фичей)
- [x] Обновить `docs/` с описанием новых возможностей
